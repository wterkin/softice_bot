...
class CPoliceman(prototype.CPrototype):
    """Класс бармена."""
    ...
    def policeman(self, pchat_id: int, pchat_title: str, puser_id: int,
        ...
        if self.can_process(pchat_title, pmessage_text):
            ...
            if word_list[0] in MUTE_COMMANDS:
                ...
                self.bot.send_message(pchat_id, f"{puser_title}, помолчите пока...")
